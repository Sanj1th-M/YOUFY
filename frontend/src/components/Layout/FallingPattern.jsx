...
/**
 * FallingPattern background animation component.
 * 
 * @param {Object} props
 * @param {string} [props.color='var(--primary)'] - Primary color of the falling elements
 * @param {string} [props.backgroundColor='var(--background)'] - Background color
 * @param {number} [props.duration=150] - Animation duration in seconds
 * @param {string} [props.blurIntensity='1em'] - Blur intensity for the overlay effect
